...
import type {
  UpdateItemCommandReturnValuesOption,
  UpdateItemOptions,
} from './options'
...
> extends EntityOperation<ENTITY> {
  ...
  ) => UpdateItemCommand<ENTITY, OPTIONS>;
  [$options]: OPTIONS
  ...
  constructor(
    ...
    this.item = nextItem =>
      new UpdateItemCommand(this[$entity], nextItem, this[$options])
    this.options = nextOptions =>
      new UpdateItemCommand(this[$entity], this[$item], nextOptions)
  }

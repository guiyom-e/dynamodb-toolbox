...
describe('parseCondition - comparison', () => {
  ...
  it('equal to (value)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', eq: 42 }),
    ).toStrictEqual({
  ...
  it('not equal to (value)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', ne: 42 }),
    ).toStrictEqual({
      ConditionExpression: '#c_1 <> :c_1',
      ExpressionAttributeNames: { '#c_1': 'num' },
      ExpressionAttributeValues: { ':c_1': 42 },
  ...
  it('greater than (value)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', gt: 42 }),
    ).toStrictEqual({
      ConditionExpression: '#c_1 > :c_1',
      ExpressionAttributeNames: { '#c_1': 'num' },
      ExpressionAttributeValues: { ':c_1': 42 },
  ...
  it('greater than or equal to (value)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', gte: 42 }),
    ).toStrictEqual({
      ConditionExpression: '#c_1 >= :c_1',
      ExpressionAttributeNames: { '#c_1': 'num' },
      ExpressionAttributeValues: { ':c_1': 42 },
  ...
  it('less than (value)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', lt: 42 }),
    ).toStrictEqual({
      ConditionExpression: '#c_1 < :c_1',
      ExpressionAttributeNames: { '#c_1': 'num' },
      ExpressionAttributeValues: { ':c_1': 42 },
  ...
  it('less than or equal to (value)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', lte: 42 }),
    ).toStrictEqual({
      ConditionExpression: '#c_1 <= :c_1',
      ExpressionAttributeNames: { '#c_1': 'num' },
      ExpressionAttributeValues: { ':c_1': 42 },
  ...
  it('deep maps (value)', () => {
    expect(
      parseSchemaCondition(mapSchema, { attr: 'map.nestedA.nestedB', eq: 42 }),
    ).toStrictEqual({
  ...
  it('deep maps and lists (attribute)', () => {
    expect(
      ...
      ConditionExpression:
        '#c_1[1].#c_2.#c_3[2].#c_4 = #c_5[3].#c_6.#c_7[4].#c_8',
      ExpressionAttributeNames: {
        '#c_1': 'listA',
        '#c_2': 'nested',
        '#c_3': 'listB',
  ...
  it('deep lists (value)', () => {
    expect(
      parseSchemaCondition(listSchema, { attr: 'listA[1][2][3]', eq: 42 }),
    ).toStrictEqual({
  ...
  it('with size', () => {
    expect(
      parseSchemaCondition(simpleSchema, { size: 'num', eq: 42 }),
    ).toStrictEqual({

...
describe('parseCondition - between', () => {
  ...
  it('between (values)', () => {
    expect(
      parseSchemaCondition(simpleSchema, { attr: 'num', between: [42, 43] }),
    ).toStrictEqual({
  ...
  it('deep maps (attributes)', () => {
    expect(
      parseSchemaCondition(deepMapsSchema, {
        attr: 'map.nestedA.nestedB',
        between: [
          { attr: 'nestedC.otherNum' },
          { attr: 'nestedD.yetAnotherNum' },
        ],
      }),
    ).toStrictEqual({
  ...
  it('deep maps and lists (value + attribute)', () => {
    expect(
      ...
      ConditionExpression:
        '#c_1[1].#c_2.#c_3[2].#c_4 BETWEEN :c_1 AND #c_5[3].#c_6.#c_7[4].#c_8',
      ExpressionAttributeNames: {
        '#c_1': 'listA',
        '#c_2': 'nested',
        '#c_3': 'listB',
  ...
  it('deep lists (attributes)', () => {
    expect(
      ...
      ConditionExpression:
        '#c_1[1][2][3] BETWEEN #c_2[4][5][6] AND #c_3[7][8][9]',
      ExpressionAttributeNames: {
        '#c_1': 'list',
        '#c_2': 'listB',
        '#c_3': 'listC',
  ...
  it('with size', () => {
    expect(
      parseSchemaCondition(simpleSchema, { size: 'num', between: [42, 43] }),
    ).toStrictEqual({

...
> implements DeleteItemCommand<ENTITY, OPTIONS> {
  ...
  constructor(
    ...
    this.key = nextKey =>
      new DeleteItemCommandMock(this[$mockedEntity], nextKey, this[$options])
  ...
  send = async (): Promise<DeleteItemResponse<ENTITY, OPTIONS>> => {
    this[$mockedEntity][$receivedCommands].delete.push([
      this[$key],
      this[$options],
    ])
    ...
    if (implementation !== undefined) {
      ...
      return (implementation(
        this[$key],
        this[$options],
      ) as unknown) as DeleteItemResponse<ENTITY, OPTIONS>
    }
